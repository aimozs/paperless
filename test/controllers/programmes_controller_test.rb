...
class ProgrammesControllerTest < ActionController::TestCase
  ...
  test "should create programme" do
    assert_difference('Programme.count') do
      post :create, programme: { description: @programme.description, due_date: @programme.due_date, user_id: @programme.user_id }
    end
  ...
  test "should update programme" do
    patch :update, id: @programme, programme: { description: @programme.description, due_date: @programme.due_date, user_id: @programme.user_id }
    assert_redirected_to programme_path(assigns(:programme))
  end
