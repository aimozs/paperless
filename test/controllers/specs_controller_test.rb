...
class SpecsControllerTest < ActionController::TestCase
  ...
  test "should create spec" do
    assert_difference('Spec.count') do
      post :create, spec: { exercise_id: @spec.exercise_id, programme_id: @spec.programme_id, rep: @spec.rep, serie: @spec.serie, tempo: @spec.tempo, time: @spec.time }
    end
  ...
  test "should update spec" do
    patch :update, id: @spec, spec: { exercise_id: @spec.exercise_id, programme_id: @spec.programme_id, rep: @spec.rep, serie: @spec.serie, tempo: @spec.tempo, time: @spec.time }
    assert_redirected_to spec_path(assigns(:spec))
  end
